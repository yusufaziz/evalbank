  ...
  <PaginationRoot v-bind="forwarded">
    <slot>
      <UiPaginationList v-slot="{ items }">
        <slot name="first">
          <UiPaginationFirst as-child :icon="firstIcon" />
        </slot>
        <slot name="prev">
          <UiPaginationPrev as-child :icon="prevIcon" />
        </slot>
        ...
        <slot name="next">
          <UiPaginationNext as-child :icon="nextIcon" />
        </slot>
        <slot name="last">
          <UiPaginationLast as-child :icon="lastIcon" />
        </slot>
      </UiPaginationList>
    </slot>
  </PaginationRoot>
